		...
		<div class="row camp-row">
			...
			<div class="col-lg-4 order-menu">
				<form action="<%=request.getContextPath()%>/campOrder.do"
					...
					<small class="avg-person">(每人每晚)</small>
					<hr>
